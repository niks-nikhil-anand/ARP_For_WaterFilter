...
const monthlyOrdersData = [
  { month: 'Jan', orders: 45, revenue: 125000, repairs: 8 },
  { month: 'Feb', orders: 52, revenue: 145000, repairs: 7 },
  { month: 'Mar', orders: 48, revenue: 135000, repairs: 6 },
  { month: 'Apr', orders: 61, revenue: 172000, repairs: 5 },
  { month: 'May', orders: 55, revenue: 158000, repairs: 8 },
  { month: 'Jun', orders: 67, revenue: 189000, repairs: 9 },
  { month: 'Jul', orders: 72, revenue: 205000, repairs: 10 },
  { month: 'Aug', orders: 68, revenue: 195000, repairs: 7 },
  { month: 'Sep', orders: 75, revenue: 215000, repairs: 8 },
  { month: 'Oct', orders: 82, revenue: 235000, repairs: 7 },
];
...
const DashboardPage = () => {
  ...
  const revenueStats = useMemo(() => {
    const monthly = monthlyOrdersData[monthlyOrdersData.length - 1].revenue;
    const daysInMonth = 31; // For October
    const weekly = monthly / 4;
    const daily = monthly / daysInMonth;
    const total = monthlyOrdersData.reduce((sum, row) => sum + row.revenue, 0);
    return {
      total,
      yearly: total,
      monthly,
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 my-6">
            <Card>
              ...
              <CardContent>
                ...
                <div className="text-xs mt-1 text-muted-foreground">Year-to-date</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>Monthly Revenue</CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">₹{revenueStats.monthly.toLocaleString()}</div>
                <div className="text-xs mt-1 text-muted-foreground">October 2024</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>Weekly Revenue</CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">₹{revenueStats.weekly.toLocaleString()}</div>
                <div className="text-xs mt-1 text-muted-foreground">Avg/Week (Oct)</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>Daily Revenue</CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">₹{revenueStats.daily.toLocaleString()}</div>
                <div className="text-xs mt-1 text-muted-foreground">Avg/Day (Oct)</div>
              </CardContent>
            </Card>
          </div>

          {/* Composite Stats Graph (Second Row) */}
          <Card>
            <CardHeader>
              <CardTitle>Monthly Business Trends</CardTitle>
              <CardDescription>Orders, Revenue, and Repairs (2024)</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={270}>
                <LineChart data={monthlyOrdersData}>
                  ...
                  <Line yAxisId="left" type="monotone" dataKey="repairs" stroke="#8b5cf6" name="Repairs" />
